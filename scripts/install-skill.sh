...
REPO_URL="${LINE_DOCS_SKILL_REPO_URL:-https://github.com/tbdavid2019/line-docs-skill.git}"
DEFAULT_DEST="${HOME}/.codex/skills/line-docs-skill"
DEST_DIR="${1:-$DEFAULT_DEST}"

echo "🦞 LINE Docs Skill installer"
